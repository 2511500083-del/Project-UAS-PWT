...
<div class="container">
    ...
    <div class="header">
        <h1>📚 Data Praktikum</h1>
        <p>Kelola seluruh data praktikum laboratorium</p>
    </div>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a
                        href="edit.php?id=<?= $row['id_praktikum']; ?>"
                        class="btn-edit">
                            ✏ Edit
                        </a>

                        <a
                        href="hapus.php?id=<?= $row['id_praktikum']; ?>"
                        class="btn-hapus"
